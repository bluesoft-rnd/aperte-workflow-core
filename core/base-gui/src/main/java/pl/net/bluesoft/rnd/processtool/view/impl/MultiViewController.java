...
import org.aperteworkflow.ui.view.BasicViewController;
import org.aperteworkflow.ui.view.IMultiViewController;
...
public class MultiViewController extends BasicViewController implements IMultiViewController {
	...
	private static final Logger logger = Logger.getLogger(MultiViewController.class.getName());

	public MultiViewController(ViewRenderer baseViewRenderer) 
	{
		super();
