  	...
  	$(document).ready(function()
	{
		...
		var dataTable = new AperteDataTable("customQueueTable", 
			[
				 ...
				 { "sName":"deadline","bVisible": false , "bSortable": true, "mData": function(object){return object.deadline == null ? "<spring:message code='processes.list.table.nodeadline' />" : $.format.date(object.deadline, 'dd-MM-yyyy, HH:mm');}},
