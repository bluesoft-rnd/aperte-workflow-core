...
public class OSGiBundleHelper {
	...
	public static final String		DESCRIPTION			= "Bundle-Description-Key";
	...
	public static final String[]	HEADER_NAMES		= { MODEL_ENHANCEMENT, WIDGET_ENHANCEMENT, BUTTON_ENHANCEMENT, STEP_ENHANCEMENT, I18N_PROPERTY,
		PROCESS_DEPLOYMENT, GLOBAL_DICTIONARY, ICON_RESOURCES, RESOURCES, HUMAN_NAME, DESCRIPTION, ROLE_FILES, IMPLEMENTATION_BUILD, TASK_ITEM_ENHANCEMENT};

	private Map<String, String[]>	parsedHeadersMap	= new HashMap<String, String[]>();
