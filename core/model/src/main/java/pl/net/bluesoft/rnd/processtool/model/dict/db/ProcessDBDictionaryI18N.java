...
public class ProcessDBDictionaryI18N extends AbstractPersistentEntity {
	...
	public boolean equals(Object o) {
		...
		ProcessDBDictionaryI18N i18N = (ProcessDBDictionaryI18N)o;

		if (id != null ? !id.equals(i18N.id) : i18N.id != null) return false;
		if (languageCode != null ? !languageCode.equals(i18N.languageCode) : i18N.languageCode != null) return false;
		if (text != null ? !text.equals(i18N.text) : i18N.text != null) return false;
