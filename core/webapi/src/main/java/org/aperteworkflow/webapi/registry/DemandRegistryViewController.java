package org.aperteworkflow.webapi.registry;
 ...
 */
public class DemandRegistryViewController {
    private static final String PORTLET_JSON_RESULT_ROOT_NAME = "result";

    private static Logger logger = Logger.getLogger(DemandRegistryViewController.class.getName());
	...
	public ModelAndView handleMainRenderRequest(RenderRequest request, RenderResponse response, Model model)
    {
        ...
        if(user == null || user.getLogin() == null){
            ...
            modelView.setViewName("demand_registry");
        }
