...
public class FilesRepositoryItemDAOTest {
    ...
    public void testAddItemByProperties() {
        ...
        FilesRepositoryItem newItem = dao.addItem(item1.getProcessInstance().getId(), item1.getName(), item1.getDescription(), item1.getRelativePath(), CREATOR_LOGIN);
    ...
    public void testGetItems() {
        ...
        FilesRepositoryItem newItem1 = dao.addItem(exProcessInstance.getId(), "1.txt", "1_relativePath.txt", "Description of 1.txt", CREATOR_LOGIN);
        FilesRepositoryItem newItem2 = dao.addItem(exProcessInstance.getId(), "2.txt", "2_relativePath.txt", "Description of 2.txt", CREATOR_LOGIN);
        FilesRepositoryItem newItem3 = dao.addItem(exProcessInstance.getId(), "3.txt", "3_relativePath.txt", "Description of 3.txt", CREATOR_LOGIN);
